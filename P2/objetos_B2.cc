...
void _coche::draw(_modo modo, float r, float g, float b, float grosor){
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glRotatef(-90, 0, 1, 0);
			if(activo[1] == 1)
				puertaD.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			glRotatef(-90, 0, 1, 0);
			if(activo[2] == 1)
				puertaI.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			if(activo[3] == 1)
				motor.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			if(activo[4] == 1)
				tabiqueDD.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			glScalef(0.201, 1.3, 0.201);
			if(activo[5] == 1)
				tabiqueID.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			if(activo[6] == 1)
				paredI.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			glTranslated(3.55, 0.5, 1.0);
			if(activo[7] == 1)
				paredD.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			if(activo[8] == 1)
				techo.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			glScalef(14.4, 1.45, 6);
			if(activo[9] == 1)
				maletero.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			if(activo[10] == 1)
				luzD.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			glScalef(tam_luz, 0.2, tam_luz);
			if(activo[11] == 1)
				luzI.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
		...
		glPushMatrix();
			...
			glScalef(2, 0.5, 0.2);
			if(activo[12] == 1)
				matricula.draw(EDGES, r_p, g_p, b_p, grosor_select);
			else
...
void _coche::seleccion(){
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			puertaD.draw(SELECT, color.r, color.g, color.b, 1);
		glPopMatrix();
		...
		glPushMatrix();
			...
			puertaI.draw(SELECT, color.r, color.g, color.b, 1);
		glPopMatrix();
		...
		glPushMatrix();
			...
			motor.draw(SELECT, color.r, color.g, color.b, 1);
		glPopMatrix();
		...
		glPushMatrix();
			...
			tabiqueDD.draw(SELECT, color.r, color.g, color.b, 1);
			glPopMatrix();
		...
		glPushMatrix();
			...
			tabiqueID.draw(SELECT, color.r, color.g, color.b, 1);
		glPopMatrix();
		...
		glPushMatrix();
			...
			paredI.draw(SELECT, color.r, color.g, color.b, 1);
		glPopMatrix();
		...
		glPushMatrix();
			...
			paredD.draw(SELECT, color.r, color.g, color.b, 1);
		glPopMatrix();
		...
		glPushMatrix();
			...
			techo.draw(SELECT, color.r, color.g, color.b, 1);
		glPopMatrix();
		...
		glPushMatrix();
			...
			maletero.draw(SELECT, color.r, color.g, color.b, 1);
			glPopMatrix();
		...
		glPushMatrix();
			...
			luzD.draw(SELECT, color.r, color.g, color.b, 1);
			glPopMatrix();
		...
		glPushMatrix();
			...
			luzI.draw(SELECT, color.r, color.g, color.b, 1);
			glPopMatrix();
		...
		glPushMatrix();
			...
			matricula.draw(SELECT, color.r, color.g, color.b, 1);
			glPopMatrix();
